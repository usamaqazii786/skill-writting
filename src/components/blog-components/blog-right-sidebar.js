			...
			<div className="row">
				...
				<div className="ltn__blog-list-wrap">
					...
					<div className="ltn__blog-img">
						<Link to="/blog-details"><img src={publicUrl+"assets/img/blog/31.jpg"} alt="Images" /></Link>
					</div>
					...
					<div className="ltn__video-img">
						<img src={publicUrl+"assets/img/blog/32.jpg"} alt="videopopupbgimage" />
					...
					<div className="ltn__blog-gallery-active slick-arrow-1 slick-arrow-1-inner">
						...
						<Link to="/blog-details"><img src={publicUrl+"assets/img/blog/33.jpg"} alt="Images" /></Link>
						</div>
						<div className="ltn__blog-gallery-item">
						<Link to="/blog-details"><img src={publicUrl+"assets/img/blog/34.jpg"} alt="Images" /></Link>
						</div>
						<div className="ltn__blog-gallery-item">
						<Link to="/blog-details"><img src={publicUrl+"assets/img/blog/31.jpg"} alt="Images" /></Link>
						</div>
