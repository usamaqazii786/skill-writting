    ...
    return (
    	<div>
					...
					<div className="ltn-author-introducing clearfix">
						...
						<img src={publicUrl+"assets/img/blog/author.jpg"} alt="Author#indexindex" />
						</div>
					...
					<div className="ltn__comment-inner">
						...
						<li>
							...
							<div className="ltn__commenter-img">
								<img src={publicUrl+"assets/img/testimonial/1.jpg"} alt="#indexindexsss" />
							</div>
							<div className="ltn__commenter-comment">
								<h6><a href="#indexindex">Adam Smit</a></h6>
								<span className="comment-date">20th May 2020</span>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, omnis fugit corporis iste magnam ratione.</p>
								<Link to="#index" className="ltn__comment-reply-btn"><i className="icon-reply-1" />Reply</Link>
							</div>
							</div>
							<ul>
							<li>
						...
						<li>
							<div className="ltn__comment-item clearfix">
							<div className="ltn__commenter-img">
								<img src={publicUrl+"assets/img/testimonial/4.jpg"} alt="#indexindex" />
							</div>
							<div className="ltn__commenter-comment">
								<h6><a href="#index">Adam Smit</a></h6>
