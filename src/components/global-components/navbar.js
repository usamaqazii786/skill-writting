           ...
           <header className="ltn__header-area ltn__header-5 ltn__header-transparent--- gradient-color-4---">
						...
						<ul>
							...
							<div className="ltn__drop-menu ltn__currency-menu ltn__language-menu">
								...
								<li><a href="#index" className="dropdown-toggle"><span className="active-currency">English</span></a>
									<ul>
									<li><Link to="#index">Arabic</Link></li>
									<li><Link to="#index">Bengali</Link></li>
									<li><Link to="#index">Chinese</Link></li>
									<li><Link to="#index">English</Link></li>
									<li><Link to="#index">French</Link></li>
									<li><Link to="#index">Hindi</Link></li>
									</ul>
								</li>
								</ul>
							</div>
			...
			<div className="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-white">
				...
				<div className="row">
						...
						<div className="ltn__main-menu go-top">
							...
							<li className="menu-icon"><Link to="/">Home</Link>
								...
								<li>
									...
									<img src={publicUrl+"assets/img/home-demos/home-1.jpg"} alt="#index" />
								</li>
								<li>
									<Link to="/home-v2">Home Style 02</Link>
									<img src={publicUrl+"assets/img/home-demos/home-2.jpg"} alt="#index" />
								</li>
								<li>
									<Link to="/home-v3">Home Style 03</Link>
									<img src={publicUrl+"assets/img/home-demos/home-3.jpg"} alt="#index" />
								</li>
								<li>
									<Link to="/home-v4">Home Style 04</Link>
									<img src={publicUrl+"assets/img/home-demos/home-4.jpg" } alt="#index" /> 
								</li>
								<li>
									<Link to="/home-v5">Home Style 05 <span className="menu-item-badge">video</span></Link>
									<img src={publicUrl+"assets/img/home-demos/home-5.jpg" } alt="#index" /> 
								</li>
								<li>
									<Link to="/home-v6">Home Style 06</Link>
									<img src={publicUrl+"assets/img/home-demos/home-6.jpg" } alt="#index" /> 
								</li>
								<li>
									<Link to="/home-v7">Home Style 07</Link>
									<img src={publicUrl+"assets/img/home-demos/home-7.jpg" } alt="#index" /> 
								</li>
								<li>
									<Link to="/home-v8">Home Style 08</Link>
									<img src={publicUrl+"assets/img/home-demos/home-8.jpg" } alt="#index" /> 
								</li>
								<li>
									<Link to="/home-v9">Home Style 09</Link>
									<img src={publicUrl+"assets/img/home-demos/home-9.jpg" } alt="#index" /> 
								</li>
								<li>
									<Link to="/home-v10">Home Style 10</Link>
									<img src={publicUrl+"assets/img/home-demos/home-11.jpg"}  alt="#index" />
								</li>
								</ul>
							</li>
							...
							<li className="menu-icon"><Link to="#index">Pages</Link>
								<ul className="mega-menu">
									...
									<li><Link to="#index">Inner Pages</Link>
										<ul>
									...
									<li><Link to="#index">Shop Pages</Link>
										<ul>
											<li><Link to="/shop">Shop</Link></li>
											<li><Link to="/shop-left-sidebar">Shop Left sidebar</Link></li>
											<li><Link to="/shop-right-sidebar">Shop right sidebar</Link></li>
									...
									<li><Link to="/shop"><img src={publicUrl+"assets/img/banner/menu-banner-1.jpg"} alt="#index" /></Link>
									</li>
								</ul>
							</li>
							<li><Link to="/contact">Contact</Link></li>
					...
					<div className="header-search-wrap">
						...
						<form id="#index" method="get" action="#index">
					...
					<div className="ltn__drop-menu user-menu">
						<ul>
						<li>
							<Link to="#index"><i className="icon-user" /></Link>
							<ul className="go-top">
							<li><Link to="/login">Sign in</Link></li>
							<li><Link to="/register">Register</Link></li>
							<li><Link to="/my-account">My Account</Link></li>
					...
					<div className="mini-cart-icon">
                            <a href="#indexltn__utilize-cart-menu" className="ltn__utilize-toggle">
					...
					<div className="mobile-menu-toggle d-xl-none">
						<a href="#indexltn__utilize-mobile-menu" className="ltn__utilize-toggle">
			...
			<div id="ltn__utilize-mobile-menu" className="ltn__utilize ltn__utilize-mobile-menu">
				...
				<div className="mini-cart-product-area ltn__scrollbar">
					...
					<div className="mini-cart-item clearfix">
					<div className="mini-cart-img go-top">
						<Link to="/product-details"><img src={publicUrl+"assets/img/product/4.png"} alt="#index" /></Link>
						<span className="mini-cart-item-delete"><i className="icon-cancel" /></span>
					</div>
					<div className="mini-cart-info go-top">
