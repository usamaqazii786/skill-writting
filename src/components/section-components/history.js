					...
					<div className="ltn__our-history-inner">
						...
						<div className="tab-pane fade" id="liton_tab_2_1">
							...
							<div className="row">
								...
								<div className="about-us-img-wrap about-img-left">
									<img src={publicUrl+"assets/img/img-slide/12.jpg"} alt="#index" />
						...
						<div className="tab-pane fade active show" id="liton_tab_2_2">
							...
							<div className="row">
								<div className="col-lg-6 align-self-center">
								<div className="about-us-img-wrap about-img-left">
									<img src={publicUrl+"assets/img/img-slide/11.jpg"} alt="#index" />
									<div className="ltn__history-icon">
						...
						<div className="tab-pane fade" id="liton_tab_2_3">
							...
							<div className="row">
								<div className="col-lg-6 align-self-center">
								<div className="about-us-img-wrap about-img-left">
									<img src={publicUrl+"assets/img/img-slide/13.jpg"} alt="#index" />
									<div className="ltn__history-icon">
