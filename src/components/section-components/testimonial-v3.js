			    ...
			    <div className="row">
			      <div className="col-lg-12">
			        ...
			        <ul className="ltn__testimonial-quote-menu d-none d-lg-block">
			          <li><img src={publicUrl+"assets/img/testimonial/1.jpg"} alt="Quoteimage" /></li>
			          <li><img src={publicUrl+"assets/img/testimonial/2.jpg"} alt="Quoteimage" /></li>
			          <li><img src={publicUrl+"assets/img/testimonial/3.jpg"} alt="Quoteimage" /></li>
			          <li><img src={publicUrl+"assets/img/testimonial/4.jpg"} alt="Quoteimage" /></li>
			        </ul>
			      </div>
			    </div>
			  </div>
