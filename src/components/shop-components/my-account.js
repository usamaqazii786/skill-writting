				...
				<div className="row">
				  <div className="col-lg-4">
					<div className="ltn__tab-menu-list mb-50">
					  <div className="nav">                                            
						<a className="active show" data-bs-toggle="tab" href="#indexltn_tab_1_1">Dashboard <i className="fas fa-home" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_2">Profiles <i className="fas fa-user" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_3">address <i className="fas fa-map-marker-alt" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_4">Account Details <i className="fas fa-user" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_5">My Properties <i className="fa-solid fa-list" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_6">Favorited Properties <i className="fa-solid fa-heart" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_7">Add Property <i className="fa-solid fa-map-location-dot" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_8">Payments <i className="fa-solid fa-money-check-dollar" /></a>
						<a data-bs-toggle="tab" href="#indexltn_tab_1_9">Change Password <i className="fa-solid fa-lock" /></a>
						  ...
						  <div className="ltn__comment-area mb-50">
							<div className="ltn-author-introducing clearfix">
							  <div className="author-img">
								<img src={publicUrl+"assets/img/blog/author.jpg"} alt="AuthorImage" />
							  </div>
						...
						<div className="ltn__myaccount-tab-content-inner">
						  ...
						  <div className="row">
							<div className="col-md-6 col-12 learts-mb-30">
							  <h4>Billing Address <small><Link to="#index">edit</Link></small></h4>
							  <address>
							...
							<div className="col-md-6 col-12 learts-mb-30">
							  <h4>Shipping Address <small><Link to="#index">edit</Link></small></h4>
							  <address>
								<p><strong>Alex Tuntuni</strong></p>
								<p>1355 Market St, Suite 900 <br />
								  San Francisco, CA 94103</p>
					  ...
					  <div className="tab-pane fade" id="ltn_tab_1_5">
						<div className="ltn__myaccount-tab-content-inner">
							...
							<table className="table">
							  ...
							  <tbody>
								<tr>
								  ...
								  <td>Feb 22, 2022</td>
								  <td><Link to="#index">Edit</Link></td>
								  <td><Link tp="#index"><i className="fa-solid fa-trash-can" /></Link></td>
								</tr>
								<tr>
								  <td className="ltn__my-properties-img go-top">
								...
								<tr>
								  <td className="ltn__my-properties-img go-top">
									<Link to="/product-details"><img src={publicUrl+"assets/img/product-3/7.jpg"} alt="#index" /></Link>
								  </td>
								  <td>
									<div className="ltn__my-properties-info">
									  <h6 className="mb-10 go-top"><Link to="/product-details">New Apartment Nice View</Link></h6>
						  ...
						  <div className="ltn__pagination-area text-center">
							...
							<ul>
								<li><Link to="#index"><i className="fas fa-angle-double-left" /></Link></li>
								<li><Link to="#index">1</Link></li>
								<li className="active"><Link to="#index">2</Link></li>
								<li><Link to="#index">3</Link></li>
								<li><Link to="#index">...</Link></li>
								<li><Link to="#index">10</Link></li>
								<li><Link to="#index"><i className="fas fa-angle-double-right" /></Link></li>
							</ul>
							</div>
						</div>
						</div>
							...
							<div className="col-lg-12">
							  <div className="ltn__checkout-inner">
								<div className="ltn__checkout-single-content ltn__returning-customer-wrap">
								  <h5>Returning customer? <a className="ltn__secondary-color" href="#indexltn__returning-customer-login" data-toggle="collapse">Click here to login</a></h5>
								...
								<div className="ltn__checkout-single-content ltn__coupon-code-wrap">
								  <h5>Have a coupon? <a className="ltn__secondary-color" href="#indexltn__coupon-code" data-toggle="collapse">Click here to enter your code</a></h5>
							...
							<div className="col-lg-6">
							  <div className="ltn__checkout-payment-method mt-50">
								...
								<div id="checkout_accordion_1">
								  {/* card */}
								  <div className="card">
									<h5 className="collapsed ltn__card-title" data-toggle="collapse" data-target="#indexfaq-item-2-1" aria-expanded="false">
									  Check payments
									</h5>
									<div id="faq-item-2-1" className="collapse" data-parent="#indexcheckout_accordion_1">
								  ...
								  {/* card */}
								  <div className="card">
									<h5 className="ltn__card-title" data-toggle="collapse" data-target="#indexfaq-item-2-2" aria-expanded="true"> 
									  Cash on delivery 
									</h5>
									<div id="faq-item-2-2" className="collapse show" data-parent="#indexcheckout_accordion_1">
									  <div className="card-body">
								  ...
								  {/* card */}
								  <div className="card">
									<h5 className="collapsed ltn__card-title" data-toggle="collapse" data-target="#indexfaq-item-2-3" aria-expanded="false">
									  PayPal <img src={publicUrl+"assets/img/icons/payment-3.png"} alt="#index" />
									</h5>
									<div id="faq-item-2-3" className="collapse" data-parent="#indexcheckout_accordion_1">
									  <div className="card-body">
					  ...
					  <div className="tab-pane fade" id="ltn_tab_1_9">
						<div className="ltn__myaccount-tab-content-inner">
						  <div className="account-login-inner">
							<form action="#index" className="ltn__form-box contact-form-box">
