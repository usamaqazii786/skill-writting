				...
				<div className="row">
					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
						...
						<ul>
							...
							<Link to="#index">Featured</Link>
							</li>
							<li className="ltn__blog-category">
							<Link className="bg-orange" to="#index">For Rent</Link>
							</li>
							<li className="ltn__blog-date">
							<i className="far fa-calendar-alt" />May 19, 2021
							</li>
							<li>
							<Link to="#index"><i className="far fa-comments" />35 Comments</Link>
							</li>
						</ul>
						</div>
						...
						<div className="row">
							...
							<a href={publicUrl+"assets/img/others/14.jpg"} data-rel="lightcase:myCollection">
								<img className="mb-30" src={publicUrl+"assets/img/others/14.jpg"} alt="#indexindex" />
							</a>
							<a href={publicUrl+"assets/img/others/15.jpg"} data-rel="lightcase:myCollection">
								<img className="mb-30" src={publicUrl+"assets/img/others/15.jpg"} alt="#indexindex" />
							</a>
							</div>
							<div className="col-md-6">
							<a href={publicUrl+"assets/img/others/16.jpg"} data-rel="lightcase:myCollection">
								<img className="mb-30" src={publicUrl+"assets/img/others/16.jpg"} alt="#indexindex" />
							</a>
							</div>
						</div>
						</div>
						...
						<div className="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center---">
							<div className="nav">
							<a data-bs-toggle="tab" href="#indexliton_tab_3_1">First Floor</a>
							<a className="active show" data-bs-toggle="tab" href="#indexliton_tab_3_2">Second Floor</a>
							<a data-bs-toggle="tab" href="#indexliton_tab_3_3" >Third Floor</a>
							<a data-bs-toggle="tab" href="#indexliton_tab_3_4" >Top Garden</a>
							</div>
						</div>
						<div className="tab-content">
							...
							<div className="ltn__apartments-tab-content-inner">
								...
								<div className="col-lg-7">
									...
									<img src={publicUrl+"assets/img/others/10.png"} alt="#index" />
									</div>
								</div>
						...
						<div className="ltn__video-bg-img ltn__video-popup-height-500 bg-overlay-black-50 bg-#indexindex mb-60" data-bs-bg={publicUrl+"assets/img/others/5.jpg"}>
						...
						<div className="ltn__comment-area mb-30">
							...
							<ul>
								...
								<div className="ltn__comment-item clearfix">
									...
									<img src={publicUrl+"assets/img/testimonial/1.jpg"} alt="#indexindex" />
									</div>
									<div className="ltn__commenter-comment">
									<h6><a href="#index">Adam Smit</a></h6>
									<div className="product-ratting">
										<ul>
										<li><a href="#index"><i className="fas fa-star" /></a></li>
										<li><a href="#index"><i className="fas fa-star" /></a></li>
								...
								<div className="ltn__comment-item clearfix">
									<div className="ltn__commenter-img">
									<img src={publicUrl+"assets/img/testimonial/3.jpg"} alt="#indexindex" />
									</div>
									<div className="ltn__commenter-comment">
									<h6><a href="#index">Adam Smit</a></h6>
									<div className="product-ratting">
								...
								<div className="ltn__comment-item clearfix">
									<div className="ltn__commenter-img">
									<img src={publicUrl+"assets/img/testimonial/2.jpg"} alt="#indexindex" />
									</div>
									<div className="ltn__commenter-comment">
									<h6><a href="#index">Adam Smit</a></h6>
									<div className="product-ratting">
						...
						<div className="col-xl-6 col-sm-6 col-12 go-top">
							...
							<div className="product-img">
								<Link to="/shop"><img src={publicUrl+"assets/img/product-3/1.jpg"} alt="#index" /></Link>
						...
						<div className="col-xl-6 col-sm-6 col-12 go-top">
							<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
							<div className="product-img">
								<Link to="/shop"><img src={publicUrl+"assets/img/product-3/2.jpg"} alt="#index" /></Link>
								<div className="real-estate-agent">
								<div className="agent-img">
									<Link to="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#index" /></Link>
								</div>
					...
					<aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
						...
						<div className="ltn__author-widget-inner text-center">
							<img src={publicUrl+"assets/img/team/4.jpg"} alt="#indexindex" />
							...
							<ul>
								...
								<li><a href="#index"><i className="fas fa-star-half-alt" /></a></li>
								<li><a href="#index"><i className="far fa-star" /></a></li>
								<li className="review-total"> <a href="#index"> ( 1 Reviews )</a></li>
							</ul>
							</div>
							...
							<ul>
								...
								<li><a href="#index" title="Youtube"><i className="fab fa-youtube" /></a></li>
							</ul>
							</div>
						</div>
						</div>
						...
						<ul>
							...
							<div className="top-rated-product-item clearfix">
								...
								<Link to="/product-details"><img src={publicUrl+"assets/img/product/1.png"} alt="#index" /></Link>
								</div>
							...
							<div className="top-rated-product-item clearfix">
								<div className="top-rated-product-img">
								<Link to="/product-details"><img src={publicUrl+"assets/img/product/2.png"} alt="#index" /></Link>
								</div>
								<div className="top-rated-product-info">
								<div className="product-ratting">
									<ul>
							...
							<div className="top-rated-product-item clearfix">
								<div className="top-rated-product-img">
								<Link to="/product-details"><img src={publicUrl+"assets/img/product/3.png"} alt="#index" /></Link>
								</div>
								<div className="top-rated-product-info">
								<div className="product-ratting">
									<ul>
						...
						<div className="row ltn__popular-product-widget-active slick-arrow-1">
							...
							<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
								...
								<Link to="/shop"><img src={publicUrl+"assets/img/product-3/6.jpg"} alt="#index" /></Link>
								<div className="real-estate-agent">
									<div className="agent-img">
									<Link to="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#index" /></Link>
									</div>
							...
							<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
								<div className="product-img">
								<a href="product-details.html"><img src={publicUrl+"assets/img/product-3/4.jpg" }alt="#index" /></a>
								<div className="real-estate-agent">
									<div className="agent-img">
									<Link to="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg"} alt="#index" /></Link>
									</div>
							...
							<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
								<div className="product-img">
								<a href="product-details.html"><img src={publicUrl+"assets/img/product-3/5.jpg"} alt="#index" /></a>
								<div className="real-estate-agent">
									<div className="agent-img">
									<Link to="/team-details"><img src={publicUrl+"assets/img/blog/author.jpg" }alt="#index" /></Link>
									</div>
						...
						<ul>
							...
							<div className="popular-post-widget-item clearfix">
								...
								<Link to="/blog-details"><img src={publicUrl+"assets/img/team/5.jpg"} alt="#index" /></Link>
								</div>
								...
								<div className="ltn__blog-meta">
									<ul>
									<li className="ltn__blog-date">
										<a href="#index"><i className="far fa-calendar-alt" />June 22, 2020</a>
									</li>
									</ul>
								</div>
								</div>
							...
							<div className="popular-post-widget-item clearfix">
								<div className="popular-post-widget-img">
								<Link to="/blog-details"><img src={publicUrl+"assets/img/team/6.jpg"} alt="#index" /></Link>
								</div>
								<div className="popular-post-widget-brief">
								<h6><Link to="/blog-details">Lorem ipsum dolor sit
									cing elit, sed do.</Link></h6>
							...
							<div className="popular-post-widget-item clearfix">
								<div className="popular-post-widget-img">
								<Link to="/blog-details"><img src={publicUrl+"assets/img/team/7.jpg"} alt="#index" /></Link>
								</div>
								<div className="popular-post-widget-brief">
								<h6><Link to="/blog-details">Lorem ipsum dolor sit
									cing elit, sed do.</Link></h6>
							...
							<div className="popular-post-widget-item clearfix">
								<div className="popular-post-widget-img">
								<Link to="/blog-details"><img src={publicUrl+"assets/img/team/8.jpg"} alt="#index" /></Link>
								</div>
								<div className="popular-post-widget-brief">
								<h6><Link to="/blog-details">Lorem ipsum dolor sit
									cing elit, sed do.</Link></h6>
						...
						<Link to="/shop"><img src={publicUrl+"assets/img/banner/2.jpg"} alt="#index" /></Link>
						</div>
					</aside>
					</div>
				</div>
